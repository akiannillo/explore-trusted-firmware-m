...
add_definitions(-DCY8C624ABZI_D44=1)
...
elseif(BUILD_STARTUP)
  if(CMAKE_C_COMPILER_ID STREQUAL "ARMCLANG")
    ...
    list(APPEND ALL_SRC_ASM_BL2 "${PLATFORM_DIR}/target/cypress/psoc64/Device/Source/armclang/startup_psoc64_bl2.s")
  elseif(CMAKE_C_COMPILER_ID STREQUAL "GNUARM")
    ...
    list(APPEND ALL_SRC_ASM_BL2 "${PLATFORM_DIR}/target/cypress/psoc64/Device/Source/gcc/startup_psoc64_bl2.S")
