...
if(COMPILER STREQUAL "ARMCLANG")
    set (BL2_SCATTER_FILE_NAME "${PLATFORM_DIR}/target/cypress/psoc64/Device/Source/armclang/psoc6_bl2.sct")
...
elseif(COMPILER STREQUAL "GNUARM")
    set (BL2_SCATTER_FILE_NAME "${PLATFORM_DIR}/target/cypress/psoc64/Device/Source/gcc/psoc6_bl2.ld")
...
elseif(BUILD_CMSIS_CORE)
  ...
  list(APPEND ALL_SRC_C_BL2 "${PLATFORM_DIR}/target/cypress/psoc64/Device/Source/system_psoc6_cm0plus.c")
endif()
...
elseif(BUILD_NATIVE_DRIVERS)
  ...
  list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/cypress/psoc64/Native_Driver/generated_source/cycfg_dmas.c")
  ...
  list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/cypress/psoc64/Native_Driver/generated_source/cycfg_platform.c")
...
elseif(BUILD_STARTUP)
  if(CMAKE_C_COMPILER_ID STREQUAL "ARMCLANG")
    list(APPEND ALL_SRC_ASM_S "${PLATFORM_DIR}/target/cypress/psoc64/Device/Source/armclang/startup_psoc6_s.s")
    list(APPEND ALL_SRC_ASM_NS "${PLATFORM_DIR}/target/cypress/psoc64/Device/Source/armclang/startup_psoc6_ns.s")
    list(APPEND ALL_SRC_ASM_BL2 "${PLATFORM_DIR}/target/cypress/psoc64/Device/Source/armclang/startup_psoc6_bl2.s")
  elseif(CMAKE_C_COMPILER_ID STREQUAL "GNUARM")
    list(APPEND ALL_SRC_ASM_S "${PLATFORM_DIR}/target/cypress/psoc64/Device/Source/gcc/startup_psoc6_s.S")
    list(APPEND ALL_SRC_ASM_NS "${PLATFORM_DIR}/target/cypress/psoc64/Device/Source/gcc/startup_psoc6_ns.S")
    list(APPEND ALL_SRC_ASM_BL2 "${PLATFORM_DIR}/target/cypress/psoc64/Device/Source/gcc/startup_psoc6_bl2.S")
...
elseif(BUILD_TARGET_CFG)
  ...
  list(APPEND ALL_SRC_C_S "${PLATFORM_DIR}/target/cypress/psoc64/tfm_platform_system.c")
...
elseif(BUILD_TARGET_HARDWARE_KEYS)
  ...
  list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/cypress/psoc64/dummy_crypto_keys.c")
endif()
...
elseif(BUILD_TARGET_NV_COUNTERS)
  ...
  list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/cypress/psoc64/dummy_nv_counters.c")
...
elseif(BUILD_CMSIS_DRIVERS)
  list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/cypress/psoc64/driver_smpu.c")
  list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/cypress/psoc64/driver_ppu.c")
...
elseif(BUILD_BOOT_SEED)
  list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/cypress/psoc64/dummy_boot_seed.c")
endif()
...
elseif(BUILD_DEVICE_ID)
  list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/cypress/psoc64/dummy_device_id.c")
endif()
